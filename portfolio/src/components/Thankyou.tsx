...
export default function Thankyou() {
  return (
    <div className="w-full font-sans mt-10 max-w-7xl mx-auto bg-[linear-gradient(135deg,#0b1f3a_0%,#143d73_35%,#194a89_65%,#2f6db5_100%)]">
      ...
      <div className="flex flex-col lg:flex-row items-center">
        ...
        <div className="w-full lg:w-7/12 p-6 md:p-12 flex items-center">
          <div className="w-full max-w-2xl mx-auto space-y-6 text-center lg:text-left">
            ...
            <p className="text-white text-[28px] sm:text-[36px] lg:text-[45px] text-center lg:text-right">
              Thankyou
            </p>
