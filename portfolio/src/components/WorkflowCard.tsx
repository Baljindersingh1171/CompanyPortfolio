...
const WorkflowCard: React.FC<WorkflowCardsProps> = ({ steps, className = '', isDark }) => {
  return (
      ...
      {steps.map((step, index) => {
        ...
        return (
          ...
          >
            ...
            <div className="absolute top-0 left-0 w-full h-1.5 bg-[#194a89] scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left" />

            {/* Background Number (01, 02...) */}
            <div className="absolute top-2 right-4 text-6xl font-black text-gray-100 select-none -z-0 group-hover:text-[#194a89] transition-colors duration-300">
              {stepNumber}
            </div>
            ...
            <div className="relative z-10">
              {/* Icon */}
              <div className="inline-flex items-center justify-center w-14 h-14 mb-6 rounded-xl bg-violet-50 text-[#194a89] group-hover:bg-[#194a89] group-hover:text-white transition-colors duration-300 shadow-sm">
              ...
              {/* Title */}
              <h3 className="text-xl font-bold text-[#194a89] mb-3  transition-colors">
                {step.title}
              </h3>
    ...
    <div className="min-h-screen w-full font-sans mt-15 p-10 max-w-7xl mx-auto bg-[linear-gradient(135deg,#0b1f3a_0%,#143d73_35%,#194a89_65%,#2f6db5_100%)]">
