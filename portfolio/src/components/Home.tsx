    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-white">
        <div className="max-w-3xl">
          <h1 className={`text-5xl md:text-6xl font-bold mb-6 font-handwritten  ${isDark ? 'text-white' : 'text-white'}`}>
          ...
          <div className="flex space-x-4 mt-10">
            <button
              ...
              className="bg-[#FFFDF8] text-lg font-semibold px-8 py-3 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 text-[#194a89] cursor-pointer"
